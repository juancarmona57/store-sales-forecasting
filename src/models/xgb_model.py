"""XGBoost model with RMSE on log1p-transformed target."""
...
class XGBModel(BaseModel):
    """XGBoost model training on log1p(target)."""

    def __init__(self, params: Optional[Dict[str, Any]] = None):
        merged_params = {**XGB_PARAMS, **(params or {})}
        super().__init__(name="xgb_log1p", params=merged_params)
    ...
    def fit(self, X_train: pd.DataFrame, y_train: np.ndarray,
        ...
        self.model.fit(X_train, y_log, eval_set=eval_set if eval_set else None, verbose=False)
